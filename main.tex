...
\begin{document}
    ...
    \input{sec/0-glossary.tex}
    \pagestyle{plain}
    \input{sec/0-intro.tex}
    \input{sec/1-analysis.tex}
    ...
    \input{sec/2-dev-stages}
    \input{sec/2-functionality}
    \input{sec/2-architecture}
    \input{sec/2-use-case}
    ...
    \input{sec/2-mockup.tex}
    \input{sec/2-tech-review.tex}
    \input{sec/2-common-components.tex}
    \input{sec/2-activity-diagram.tex}
    ...
    \input{sec/3-impl-server.tex}
    \input{sec/3-impl-web.tex}
    \input{sec/3-impl-android.tex}
    ...
    \input{sec/closing.tex}

    \input{sec/bibliography.tex}

    \input{sec/additions.tex}
    asdasd
\end{document}