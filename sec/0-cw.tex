...
Graduate work contains: \pageref{LastPage} pages, \TotalValue{totalfigures} images, \TotalValue{totaladditions}, \TotalValue{totallistings} listings, \TotalValue{biblioCounter} bibliography sources.
