\section*{Резюме}\label{sec:cw-ru}%
...
Работа содержит: \pageref{LastPage} страниц, \TotalValue{totalfigures} рисунков, ? приложений, \TotalValue{totallistings} листингов, ? использованных источника литературы.
...
Diploma contains: \pageref{LastPage} pages, \TotalValue{totalfigures} images, ? приложений, \TotalValue{totallistings} listings, ? использованных источника литературы.
