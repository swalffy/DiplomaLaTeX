...
\widowpenalty=100 % Запрещаем разрыв страницы после последней строки абзаца
...
\captionsetup[lstlisting]{font=small, justification=centering, labelsep=defffis, format=plain, labelfont=bf, textfont=bf} % Подпись листинга по центру
...
\titleformat{\section}{\large\bfseries\clearpage}{}{0mm}{\centering{\MakeUppercase{#1}}\vspace{18pt}\setcounter{figure}{0}\setcounter{lstlisting}{0}}
...
% Bibliography nubering
\makeatletter
\renewcommand*{\@biblabel}[1]{\hfill#1.}
\makeatother

\makeatletter
\g@addto@macro\@openbib@code{\setlength{\itemsep}{-2pt}}
\makeatother
...
%     \emph{\capmystring{Приложение} \theadditionCounter}. #2
% }
...
\newcommand{\listing}[4] {
  \begin{minipage}{\textwidth}
    \begin{lstlisting}[language=#1, captionpos=b,
      label={lis:#2},
      caption={#3}
      ]
      #4
